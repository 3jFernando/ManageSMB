         ...
         <form action="app/index.php" method="post">
            <div class="row">
               <div class="col-sm-12 col-md-6 form-group">
                  ...
                  <input type="text" name="user" class="form-control" value="leidy"/> 
                  <small>Nombre de usuario del PC al que quieres acceder</small>
               </div>
               <div class="col-sm-12 col-md-6 form-group">
                  <label for="password"><b>Ingresa la Contraseña (*)</b></label><br>
                  <input type="text" name="password" class="form-control" value="petunia23"/>
            ...
            <div class="row mt-2">
               <div class="col-sm-12 col-md-6 form-group">
                  ...
                  <input type="text" name="host" class="form-control" value="192.168.100.13"/>
                  <small>Host/IP del PC al que quieres acceder</small>
               </div>
               <div class="col-sm-12 col-md-6 form-group">
                  <label for="workgroup"><b>Grupo de Trabajo (*)</b></label><br>
                  <input type="text" name="workgroup" class="form-control" value="WORKGROUP"/>
            ...
            <div class="form-group mt-2">
               ...
               <input type="text" name="share" class="form-control" value=""/>
